...
function CreateTicket() {
  return (
    <div className="container mt-4">
      <div className="row">
        <h4 className="text-muted fs-5 mb-5">To create a ticket, select a relevant topic</h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5"><i class="fa-regular fa-user"></i> Your Zerodha Account</h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5"><i class="fa-solid fa-chart-simple"></i> Trading and Markets</h4>
          ...
          <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Product and order type</a><br/>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5"><i class="fa-regular fa-credit-card"></i> Funds</h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5"> <i class="fa-regular fa-circle"></i> Console</h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="fs-5"><i class="fa-solid fa-bomb"></i> Coin</h4>
